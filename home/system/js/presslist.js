...
$(function(){
	jQuery.extend({
		...
		search: function(){
			...
			var params = '&filename=presslist';	// 受注画面への遷移の際に渡すクエリストリング
				...
				data:{'act':'search','mode':'presslist', 'field1[]':field, 'data1[]':data}, success: function(r){
					if(r instanceof Array){
						if(r.length==0){
							...
							list += '<tr><th>受注No.</th><th>混合</th><th>工場</th><th>納期</th><th>作業予定</th><th>顧客名</th><th>題　名</th><th>特記</th><th>種類</th>';
							list += '<th>商品種類</th><th>枚数</th><th>入荷予定</th><th>転写紙予定</th><th>箇所</th>';
							list += '<th>ｼｮｯﾄ</th><th>袋詰</th><th>プレス</th><th>調整</th><th>仕事量</th><th>終了</th>';
							list += '</tr></thead>';
