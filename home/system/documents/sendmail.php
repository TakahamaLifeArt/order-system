	...
	try{
		...
		switch($doctype){
			case 'estimation':
				...
				$doc_title .= "\n＜消費税法改正に伴う対応のお知らせ＞\n";
				$doc_title .= "いつもタカハマライフアートをご利用いただき、誠にありがとうございます。\n";
				$doc_title .= "2019年10月1日より消費税率が8%から10%に引き上げられることに伴い、ご注文時における消費税の取り扱いにつきまして、以下の通り対応させていただくことになりました。\n\n";
				$doc_title .= "2019年9月30日までに発送が完了するご注文：8%\n";
				$doc_title .= "2019年10月1日以降、発送が完了するご注文：10%\n\n";
				$doc_title .= "何卒ご理解賜りますよう宜しくお願い申し上げます。\n\n";

				$doc_title .= "\n＜運賃値上げによる顧客ランク制度変更のご案内＞\n";
				$doc_title .= "誠に勝手ながら、2019年10月1日（火）より顧客ランク制度の変更をさせて頂きます。\n\n";
				$doc_title .= "対象：ブロンズ会員、シルバー会員、ゴールド会員\n";
				$doc_title .= "アイテム代+プリント代が ¥30,000以下（税抜）の場合、お届け先1ヶ所につき、全国一律 ¥700を徴収させて頂きます。\n\n";
